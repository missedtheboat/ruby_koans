...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string #This is interesting
    original_string = "Hello, "
    hi = original_string
    there = "World"
    hi << there
    ...
    #
    # Rather than create a new object with +=, << utilizes concatenation
  end
  ...
  def test_strings_can_be_split_with_different_patterns
    ...
    # enlightened about them soon. - Great!
  end

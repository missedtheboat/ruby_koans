...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Many occurrances are possible and matched while still allowing the overall match to succeed. 
  # Lazy matching makes minimal amount of matches for the overall success of matching. 
  ...
  # This works because the regexp looks for "a" only in words that start with "c" "b" or "r". Thus, "zat" is
  # excluded
